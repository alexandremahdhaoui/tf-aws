...
type ArgumentOrAttribute struct {
	...
	// If not specified and user specifies a default, the default will be dropped.
...
func (t *Metadata) Debug(i int) {
	...
	debugString("Label", fmt.Sprint(t.Label), i)
	debugString("Annotations", fmt.Sprint(t.Annotations), i)
}
