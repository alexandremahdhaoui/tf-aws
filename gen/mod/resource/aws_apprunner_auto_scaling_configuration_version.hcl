resource "aws_apprunner_auto_scaling_configuration_version" "aws_apprunner_auto_scaling_configuration_version" {
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_apprunner_auto_scaling_configuration_version"
      "kind/version"                = "v0.1.0"
    }
  }
}
