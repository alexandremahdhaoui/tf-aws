resource "aws_ce_cost_allocation_tag" "aws_ce_cost_allocation_tag" {
  id      = var.id
  status  = var.status
  tag_key = var.tag_key
}
...
output "type" {
  ...
  value       = aws_ce_cost_allocation_tag.aws_ce_cost_allocation_tag.type
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_ce_cost_allocation_tag"
      "kind/version"                = "v0.1.0"
    }
  }
}
