...
output "traffic_policy_id" {
  description = "(Required) ID of the traffic policy that you want to use to create resource record sets in the specified hosted zone."
  value       = aws_route53_traffic_policy_instance.aws_route53_traffic_policy_instance.traffic_policy_id
}
...
output "id" {
  ...
  value       = aws_route53_traffic_policy_instance.aws_route53_traffic_policy_instance.id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_route53_traffic_policy_instance"
      "kind/version"                = "v0.1.0"
    }
  }
}
