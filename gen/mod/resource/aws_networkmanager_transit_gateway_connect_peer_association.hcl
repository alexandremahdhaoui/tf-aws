...
output "link_id" {
  description = "(Optional) The ID of the link."
  value       = aws_networkmanager_transit_gateway_connect_peer_association.aws_networkmanager_transit_gateway_connect_peer_association.link_id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_networkmanager_transit_gateway_connect_peer_association"
      "kind/version"                = "v0.1.0"
    }
  }
}
