resource "aws_route53_resolver_firewall_domain_list.markdown" "aws_route53_resolver_firewall_domain_list.markdown" {
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_route53_resolver_firewall_domain_list.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
