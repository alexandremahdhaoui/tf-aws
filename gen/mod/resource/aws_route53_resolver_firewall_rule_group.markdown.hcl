resource "aws_route53_resolver_firewall_rule_group.markdown" "aws_route53_resolver_firewall_rule_group.markdown" {
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_route53_resolver_firewall_rule_group.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
