...
output "arn" {
  description = "The ARN of the virtual interface."
  value       = aws_dx_hosted_public_virtual_interface_accepter.aws_dx_hosted_public_virtual_interface_accepter.arn
}
output "create" {
  description = "(Default 10m)"
...
output "delete" {
  description = "(Default 10m)"
  value       = aws_dx_hosted_public_virtual_interface_accepter.aws_dx_hosted_public_virtual_interface_accepter.delete
}
output "id" {
  description = "The ID of the virtual interface."
  value       = aws_dx_hosted_public_virtual_interface_accepter.aws_dx_hosted_public_virtual_interface_accepter.id
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_dx_hosted_public_virtual_interface_accepter"
      "kind/version"                = "v0.1.0"
    }
  }
}
