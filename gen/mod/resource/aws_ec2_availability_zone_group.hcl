resource "aws_ec2_availability_zone_group" "aws_ec2_availability_zone_group" {
...
output "id" {
  ...
  value       = aws_ec2_availability_zone_group.aws_ec2_availability_zone_group.id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_ec2_availability_zone_group"
      "kind/version"                = "v0.1.0"
    }
  }
}
