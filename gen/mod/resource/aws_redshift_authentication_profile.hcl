resource "aws_redshift_authentication_profile" "aws_redshift_authentication_profile" {
...
output "id" {
  ...
  value       = aws_redshift_authentication_profile.aws_redshift_authentication_profile.id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_redshift_authentication_profile"
      "kind/version"                = "v0.1.0"
    }
  }
}
