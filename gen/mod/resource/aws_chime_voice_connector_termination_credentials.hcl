...
output "id" {
  ...
  value       = aws_chime_voice_connector_termination_credentials.aws_chime_voice_connector_termination_credentials.id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_chime_voice_connector_termination_credentials"
      "kind/version"                = "v0.1.0"
    }
  }
}
