resource "aws_ec2_managed_prefix_list_entry" "aws_ec2_managed_prefix_list_entry" {
  cidr           = var.cidr
...
output "id" {
  ...
  value       = aws_ec2_managed_prefix_list_entry.aws_ec2_managed_prefix_list_entry.id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_ec2_managed_prefix_list_entry"
      "kind/version"                = "v0.1.0"
    }
  }
}
