resource "aws_route53_resolver_query_log_config_association" "aws_route53_resolver_query_log_config_association" {
...
output "id" {
  ...
  value       = aws_route53_resolver_query_log_config_association.aws_route53_resolver_query_log_config_association.id
}
output "provider_region" {
  description = "Region where the provider should be executed."
  type        = string
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_route53_resolver_query_log_config_association"
      "kind/version"                = "v0.1.0"
    }
  }
}
