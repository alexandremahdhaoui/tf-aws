...
output "tags_all" {
  ...
  value       = aws_config_aggregate_authorization.markdown.aws_config_aggregate_authorization.markdown.tags_all
}
output "provider_region" {
  description = "Region where the provider should be executed."
  type        = string
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_config_aggregate_authorization.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
