...
output "status_code" {
  description = "(Optional) HTTP status code of the Gateway Response."
  value       = aws_api_gateway_gateway_response.markdown.aws_api_gateway_gateway_response.markdown.status_code
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_api_gateway_gateway_response.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
