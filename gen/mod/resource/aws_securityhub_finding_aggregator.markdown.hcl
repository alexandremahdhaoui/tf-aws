resource "aws_securityhub_finding_aggregator.markdown" "aws_securityhub_finding_aggregator.markdown" {
...
output "arn" {
  ...
  value       = aws_securityhub_finding_aggregator.markdown.aws_securityhub_finding_aggregator.markdown.arn
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_securityhub_finding_aggregator.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
