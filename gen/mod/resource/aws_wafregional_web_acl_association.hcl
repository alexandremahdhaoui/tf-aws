resource "aws_wafregional_web_acl_association" "aws_wafregional_web_acl_association" {
...
output "id" {
  ...
  value       = aws_wafregional_web_acl_association.aws_wafregional_web_acl_association.id
}
output "provider_region" {
  description = "Region where the provider should be executed."
  type        = string
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_wafregional_web_acl_association"
      "kind/version"                = "v0.1.0"
    }
  }
}
