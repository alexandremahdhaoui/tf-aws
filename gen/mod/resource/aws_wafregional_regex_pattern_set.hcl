resource "aws_wafregional_regex_pattern_set" "aws_wafregional_regex_pattern_set" {
  name                  = var.name
...
output "id" {
  ...
  value       = aws_wafregional_regex_pattern_set.aws_wafregional_regex_pattern_set.id
}
output "provider_region" {
  description = "Region where the provider should be executed."
  type        = string
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_wafregional_regex_pattern_set"
      "kind/version"                = "v0.1.0"
    }
  }
}
