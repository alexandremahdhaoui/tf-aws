...
variable "tags" {
  description = "default_tags configuration block present, tags with matching keys will overwrite those defined at the provider-level.A identity_info block supports the following arguments:"
  type        = string
}
variable "tags_all" {
