resource "aws_sagemaker_servicecatalog_portfolio_status" "aws_sagemaker_servicecatalog_portfolio_status" {
  status = var.status
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_sagemaker_servicecatalog_portfolio_status"
      "kind/version"                = "v0.1.0"
    }
  }
}
