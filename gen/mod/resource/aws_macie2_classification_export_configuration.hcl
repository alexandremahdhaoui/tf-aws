...
output "id" {
  ...
  value       = aws_macie2_classification_export_configuration.aws_macie2_classification_export_configuration.id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_macie2_classification_export_configuration"
      "kind/version"                = "v0.1.0"
    }
  }
}
