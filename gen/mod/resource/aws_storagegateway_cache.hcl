resource "aws_storagegateway_cache" "aws_storagegateway_cache" {
  disk_id     = var.disk_id
...
output "id" {
  ...
  value       = aws_storagegateway_cache.aws_storagegateway_cache.id
}
output "provider_region" {
  description = "Region where the provider should be executed."
  type        = string
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_storagegateway_cache"
      "kind/version"                = "v0.1.0"
    }
  }
}
