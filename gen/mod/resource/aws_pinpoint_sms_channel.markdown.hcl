...
output "transactional_messages_per_second" {
  ...
  value       = aws_pinpoint_sms_channel.markdown.aws_pinpoint_sms_channel.markdown.transactional_messages_per_second
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_pinpoint_sms_channel.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
