resource "aws_opsworks_static_web_layer" "aws_opsworks_static_web_layer" {
  iops                        = var.iops
...
output "system_packages" {
  description = "(Optional) Names of a set of system packages to install on the layer's instances."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.system_packages
}
output "arn" {
  description = "The Amazon Resource Name(ARN) of the layer."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.arn
}
output "auto_assign_public_ips" {
  description = "(Optional) For stacks belonging to a VPC, whether to automatically assign a public IP address to each of the layer's instances."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.auto_assign_public_ips
}
output "custom_instance_profile_arn" {
  description = "(Optional) The ARN of an IAM profile that will be used for the layer's instances."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.custom_instance_profile_arn
}
output "drain_elb_on_shutdown" {
  description = "(Optional) Whether to enable Elastic Load Balancing connection draining."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.drain_elb_on_shutdown
}
output "elastic_load_balancer" {
  description = "(Optional) Name of an Elastic Load Balancer to attach to this layer"
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.elastic_load_balancer
}
output "instance_shutdown_timeout" {
  description = "(Optional) The time, in seconds, that OpsWorks will wait for Chef to complete after triggering the Shutdown event."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.instance_shutdown_timeout
}
output "name" {
  description = "(Optional) A human-readable name for the layer."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.name
}
output "custom_shutdown_recipes" {
  description = ""
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.custom_shutdown_recipes
}
output "ebs_volume" {
  description = "(Optional) ebs_volume blocks, as described below, will each create an EBS volume and connect it to the layer's instances."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.ebs_volume
}
output "id" {
  description = "The id of the layer."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.id
}
output "tags" {
  description = "(Optional) A map of tags to assign to the resource. If configured with a provider default_tags configuration block present, tags with matching keys will overwrite those defined at the provider-level."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.tags
}
output "type" {
  description = "(Optional) The type of volume to create. This may be standard (the default), io1 or gp2."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.type
}
output "iops" {
  description = "(Optional) For PIOPS volumes, the IOPS per disk.In addition to all arguments above, the following attributes are exported:"
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.iops
}
output "custom_undeploy_recipes" {
  description = "An ebs_volume block supports the following arguments:"
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.custom_undeploy_recipes
}
output "size" {
  description = "(Required) The size of the volume in gigabytes."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.size
}
output "custom_security_group_ids" {
  description = "(Optional) Ids for a set of security groups to apply to the layer's instances."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.custom_security_group_ids
}
output "install_updates_on_boot" {
  description = "(Optional) Whether to install OS and package updates on each instance when it boots."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.install_updates_on_boot
}
output "auto_healing" {
  description = "(Optional) Whether to enable auto-healing for the layer."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.auto_healing
}
output "custom_deploy_recipes" {
  description = ""
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.custom_deploy_recipes
}
output "custom_setup_recipes" {
  description = ""
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.custom_setup_recipes
}
output "stack_id" {
  description = "(Required) ID of the stack the layer will belong to."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.stack_id
}
output "custom_configure_recipes" {
  description = ""
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.custom_configure_recipes
}
output "auto_assign_elastic_ips" {
  description = "(Optional) Whether to automatically assign an elastic IP address to the layer's instances."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.auto_assign_elastic_ips
}
output "mount_point" {
  description = "(Required) The path to mount the EBS volume on the layer's instances."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.mount_point
}
output "number_of_disks" {
  description = "(Required) The number of disks to use for the EBS volume."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.number_of_disks
}
output "raid_level" {
  description = "(Required) The RAID level to use for the volume."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.raid_level
}
output "use_ebs_optimized_instances" {
  description = "(Optional) Whether to use EBS-optimized instances."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.use_ebs_optimized_instances
}
output "arn" {
  description = "The Amazon Resource Name(ARN) of the layer."
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.arn
...
output "tags_all" {
  ...
  value       = aws_opsworks_static_web_layer.aws_opsworks_static_web_layer.tags_all
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_opsworks_static_web_layer"
      "kind/version"                = "v0.1.0"
    }
  }
}
