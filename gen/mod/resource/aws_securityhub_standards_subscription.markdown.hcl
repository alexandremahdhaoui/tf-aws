resource "aws_securityhub_standards_subscription.markdown" "aws_securityhub_standards_subscription.markdown" {
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_securityhub_standards_subscription.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
