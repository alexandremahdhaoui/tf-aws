...
output "user_id" {
  ...
  value       = aws_cloud9_environment_membership.markdown.aws_cloud9_environment_membership.markdown.user_id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_cloud9_environment_membership.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
