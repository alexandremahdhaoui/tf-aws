resource "aws_worklink_website_certificate_authority_association" "aws_worklink_website_certificate_authority_association" {
...
output "website_ca_id" {
  ...
  value       = aws_worklink_website_certificate_authority_association.aws_worklink_website_certificate_authority_association.website_ca_id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_worklink_website_certificate_authority_association"
      "kind/version"                = "v0.1.0"
    }
  }
}
