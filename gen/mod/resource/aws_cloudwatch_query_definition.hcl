resource "aws_cloudwatch_query_definition" "aws_cloudwatch_query_definition" {
...
output "query_definition_id" {
  ...
  value       = aws_cloudwatch_query_definition.aws_cloudwatch_query_definition.query_definition_id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_cloudwatch_query_definition"
      "kind/version"                = "v0.1.0"
    }
  }
}
