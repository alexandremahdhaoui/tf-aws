resource "aws_connect_lambda_function_association.markdown" "aws_connect_lambda_function_association.markdown" {
...
output "id" {
  ...
  value       = aws_connect_lambda_function_association.markdown.aws_connect_lambda_function_association.markdown.id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_connect_lambda_function_association.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
