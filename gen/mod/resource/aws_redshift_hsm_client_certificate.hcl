...
variable "hsm_client_certificate_public_key" {
...
output "hsm_client_certificate_identifier" {
  description = "(Required, Forces new resource) The identifier of the HSM client certificate."
  value       = aws_redshift_hsm_client_certificate.aws_redshift_hsm_client_certificate.hsm_client_certificate_identifier
}
output "provider_region" {
  description = "Region where the provider should be executed."
  type        = string
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_redshift_hsm_client_certificate"
      "kind/version"                = "v0.1.0"
    }
  }
}
