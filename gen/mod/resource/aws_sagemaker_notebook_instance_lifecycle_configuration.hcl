...
output "arn" {
  ...
  value       = aws_sagemaker_notebook_instance_lifecycle_configuration.aws_sagemaker_notebook_instance_lifecycle_configuration.arn
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_sagemaker_notebook_instance_lifecycle_configuration"
      "kind/version"                = "v0.1.0"
    }
  }
}
