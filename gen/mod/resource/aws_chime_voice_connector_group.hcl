resource "aws_chime_voice_connector_group" "aws_chime_voice_connector_group" {
...
output "id" {
  ...
  value       = aws_chime_voice_connector_group.aws_chime_voice_connector_group.id
}
output "provider_region" {
  description = "Region where the provider should be executed."
  type        = string
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_chime_voice_connector_group"
      "kind/version"                = "v0.1.0"
    }
  }
}
