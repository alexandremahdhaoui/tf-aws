resource "aws_shield_protection_health_check_association" "aws_shield_protection_health_check_association" {
...
output "id" {
  ...
  value       = aws_shield_protection_health_check_association.aws_shield_protection_health_check_association.id
}
output "provider_region" {
  description = "Region where the provider should be executed."
  type        = string
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_shield_protection_health_check_association"
      "kind/version"                = "v0.1.0"
    }
  }
}
