resource "aws_cognito_identity_pool.markdown" "aws_cognito_identity_pool.markdown" {
}
...
output "tags_all" {
  ...
  value       = aws_cognito_identity_pool.markdown.aws_cognito_identity_pool.markdown.tags_all
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_cognito_identity_pool.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
