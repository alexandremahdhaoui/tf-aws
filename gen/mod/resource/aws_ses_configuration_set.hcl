resource "aws_ses_configuration_set" "aws_ses_configuration_set" {
}
...
output "last_fresh_start" {
  ...
  value       = aws_ses_configuration_set.aws_ses_configuration_set.last_fresh_start
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_ses_configuration_set"
      "kind/version"                = "v0.1.0"
    }
  }
}
