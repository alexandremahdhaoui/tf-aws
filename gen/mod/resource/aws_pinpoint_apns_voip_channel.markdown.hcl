resource "aws_pinpoint_apns_voip_channel.markdown" "aws_pinpoint_apns_voip_channel.markdown" {
  team_id                       = var.team_id
...
output "application_id" {
  description = "(Required) The application ID."
  value       = aws_pinpoint_apns_voip_channel.markdown.aws_pinpoint_apns_voip_channel.markdown.application_id
}
output "bundle_id" {
  description = "(Required) The ID assigned to your iOS app. To find this value, choose Certificates, IDs & Profiles, choose App IDs in the Identifiers section, and choose your app."
  value       = aws_pinpoint_apns_voip_channel.markdown.aws_pinpoint_apns_voip_channel.markdown.bundle_id
}
output "certificate" {
  description = "(Required) The pem encoded TLS Certificate from Apple."
  value       = aws_pinpoint_apns_voip_channel.markdown.aws_pinpoint_apns_voip_channel.markdown.certificate
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_pinpoint_apns_voip_channel.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
