resource "aws_apprunner_vpc_connector" "aws_apprunner_vpc_connector" {
}
...
output "vpc_connector_arn" {
  ...
  value       = aws_apprunner_vpc_connector.aws_apprunner_vpc_connector.vpc_connector_arn
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_apprunner_vpc_connector"
      "kind/version"                = "v0.1.0"
    }
  }
}
