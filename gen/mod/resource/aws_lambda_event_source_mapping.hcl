...
output "last_processing_result" {
  ...
  value       = aws_lambda_event_source_mapping.aws_lambda_event_source_mapping.last_processing_result
}
output "state" {
  description = "The state of the event source mapping."
  value       = aws_lambda_event_source_mapping.aws_lambda_event_source_mapping.state
}
output "state_transition_reason" {
  description = "The reason the event source mapping is in its current state."
  value       = aws_lambda_event_source_mapping.aws_lambda_event_source_mapping.state_transition_reason
}
output "uuid" {
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_lambda_event_source_mapping"
      "kind/version"                = "v0.1.0"
    }
  }
}
