resource "aws_codecommit_approval_rule_template_association" "aws_codecommit_approval_rule_template_association" {
...
output "id" {
  ...
  value       = aws_codecommit_approval_rule_template_association.aws_codecommit_approval_rule_template_association.id
}
output "provider_region" {
  description = "Region where the provider should be executed."
  type        = string
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_codecommit_approval_rule_template_association"
      "kind/version"                = "v0.1.0"
    }
  }
}
