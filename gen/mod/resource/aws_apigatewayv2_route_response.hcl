...
output "response_models" {
  description = "(Optional) Response models for the route response.In addition to all arguments above, the following attributes are exported:"
  value       = aws_apigatewayv2_route_response.aws_apigatewayv2_route_response.response_models
}
output "route_id" {
  description = "(Required) Identifier of the aws_apigatewayv2_route."
...
output "id" {
  ...
  value       = aws_apigatewayv2_route_response.aws_apigatewayv2_route_response.id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_apigatewayv2_route_response"
      "kind/version"                = "v0.1.0"
    }
  }
}
