resource "aws_ram_principal_association.markdown" "aws_ram_principal_association.markdown" {
...
output "id" {
  ...
  value       = aws_ram_principal_association.markdown.aws_ram_principal_association.markdown.id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_ram_principal_association.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
