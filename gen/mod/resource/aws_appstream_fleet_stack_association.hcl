resource "aws_appstream_fleet_stack_association" "aws_appstream_fleet_stack_association" {
...
output "id" {
  ...
  value       = aws_appstream_fleet_stack_association.aws_appstream_fleet_stack_association.id
}
output "provider_region" {
  description = "Region where the provider should be executed."
  type        = string
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_appstream_fleet_stack_association"
      "kind/version"                = "v0.1.0"
    }
  }
}
