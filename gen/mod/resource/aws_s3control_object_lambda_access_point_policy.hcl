resource "aws_s3control_object_lambda_access_point_policy" "aws_s3control_object_lambda_access_point_policy" {
...
output "name" {
  description = "(Required) The name of the Object Lambda Access Point."
  value       = aws_s3control_object_lambda_access_point_policy.aws_s3control_object_lambda_access_point_policy.name
}
output "policy" {
  description = "(Required) The Object Lambda Access Point resource policy document.In addition to all arguments above, the following attributes are exported:"
...
output "id" {
  ...
  value       = aws_s3control_object_lambda_access_point_policy.aws_s3control_object_lambda_access_point_policy.id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_s3control_object_lambda_access_point_policy"
      "kind/version"                = "v0.1.0"
    }
  }
}
