resource "aws_route53_resolver_firewall_rule_group_association.markdown" "aws_route53_resolver_firewall_rule_group_association.markdown" {
}
...
output "tags_all" {
  ...
  value       = aws_route53_resolver_firewall_rule_group_association.markdown.aws_route53_resolver_firewall_rule_group_association.markdown.tags_all
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_route53_resolver_firewall_rule_group_association.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
