resource "aws_dataexchange_revision" "aws_dataexchange_revision" {
}
...
output "id" {
  ...
  value       = aws_dataexchange_revision.aws_dataexchange_revision.id
}
output "revision_id" {
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_dataexchange_revision"
      "kind/version"                = "v0.1.0"
    }
  }
}
