resource "aws_licensemanager_association.markdown" "aws_licensemanager_association.markdown" {
...
output "id" {
  ...
  value       = aws_licensemanager_association.markdown.aws_licensemanager_association.markdown.id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_licensemanager_association.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
