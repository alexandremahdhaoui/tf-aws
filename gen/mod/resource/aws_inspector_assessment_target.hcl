resource "aws_inspector_assessment_target" "aws_inspector_assessment_target" {
  name               = var.name
...
output "arn" {
  ...
  value       = aws_inspector_assessment_target.aws_inspector_assessment_target.arn
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_inspector_assessment_target"
      "kind/version"                = "v0.1.0"
    }
  }
}
