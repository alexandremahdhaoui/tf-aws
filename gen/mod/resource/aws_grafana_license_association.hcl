resource "aws_grafana_license_association" "aws_grafana_license_association" {
  free_trial_expiration = var.free_trial_expiration
...
output "license_expiration" {
  ...
  value       = aws_grafana_license_association.aws_grafana_license_association.license_expiration
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_grafana_license_association"
      "kind/version"                = "v0.1.0"
    }
  }
}
