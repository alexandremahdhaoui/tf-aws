resource "aws_s3_bucket_request_payment_configuration" "aws_s3_bucket_request_payment_configuration" {
  bucket                = var.bucket
...
output "id" {
  ...
  value       = aws_s3_bucket_request_payment_configuration.aws_s3_bucket_request_payment_configuration.id
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_s3_bucket_request_payment_configuration"
      "kind/version"                = "v0.1.0"
    }
  }
}
