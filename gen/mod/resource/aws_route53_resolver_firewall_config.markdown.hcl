resource "aws_route53_resolver_firewall_config.markdown" "aws_route53_resolver_firewall_config.markdown" {
}
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_route53_resolver_firewall_config.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
