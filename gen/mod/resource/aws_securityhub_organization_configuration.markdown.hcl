resource "aws_securityhub_organization_configuration.markdown" "aws_securityhub_organization_configuration.markdown" {
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_securityhub_organization_configuration.markdown"
      "kind/version"                = "v0.1.0"
    }
  }
}
