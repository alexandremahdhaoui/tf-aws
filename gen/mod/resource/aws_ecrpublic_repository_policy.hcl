resource "aws_ecrpublic_repository_policy" "aws_ecrpublic_repository_policy" {
  policy          = var.policy
...
output "registry_id" {
  ...
  value       = aws_ecrpublic_repository_policy.aws_ecrpublic_repository_policy.registry_id
}
output "provider_region" {
  description = "Region where the provider should be executed."
  type        = string
...
provider "aws" {
  ...
  default_tags {
    tags {
      ...
      "kind/name"                   = "aws_ecrpublic_repository_policy"
      "kind/version"                = "v0.1.0"
    }
  }
}
